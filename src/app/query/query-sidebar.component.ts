...
export class QuerySidebarComponent implements OnInit, AfterViewInit {
  ...
  constructor(private _queryService: QueryService, private _filterService: FilterService, private _eventBus: EventBusService, private _configService: AppConfig, private appService: QuerySideBarService) {
